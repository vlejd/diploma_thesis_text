...
\section{Machine learning}
    ...
    This classifier has a lot of nice properties: 
    $g'(x) = g(x)(1-g(x))$.
    Good for classification, because it is from 0 to one. Other nice properties.
    \* %TODO fix me
    
    
    In general, neural networks represent very broad family of functions.
    ...
    \subsection{SVM}
    \emph{Suport vector machine} (SVM) one of the most popular classifiers before NNs. Not trained with backprop, 
    Optimized maximal margin.
    We do not use it directly in thesis, but we use it in benchmarks.
    \* % TODO fix me
    \* % cite something
