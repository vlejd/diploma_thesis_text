...
\end{table}
    ...
    \* %compare to word vectos, compare to logistic regression, discuss overfitting.
     

    \subsection{Neural embedding baselines}
    
    Thanks to results of Levy et al.\ref{levy2014neural} discussed in section \label{sec:count:vs:predict} we know, that LSA is to some extend equivalent to neural embeddings.
    ...
    \* %datasets where lsa is better and explanation
    
    % section Our approach
    {\input{ch41_our_approach}}