...
\section{Implementation}
    ...
    In this thesis we made use of the free trial provided by Google Cloud \footnote{\url{https://cloud.google.com/}}.
    This trial provides $300\$$ credit that can be spend on spawning virtual machines. 
